...
$lang = array_merge($lang, array(
	...
	'DIGESTS_DISCLAIMER'				=> 'Diese eMail-Zusammenfassung wird auf eigenen Wunsch an dich, als registrierten Teilnehmer von \'<a href="%1$s">%2$s</a>\' versandt. Du kannst dein Abonnement jederzeit ändern oder löschen, indem du deinen <a href="%1$sucp.%3$s">Persönlichen Bereich</a> im Forum aufrufst und dort bei den Einstellungen der email-Zusammenfassung entsprechende Änderungen vornimmst. Bei Problemen oder über das Forum nicht lösbaren Fragen (Themenbereich \"Technische Fragen\") kannst du dich ggf. auch direkt an <a href="mailto:%4$s?subject=Digests">%1$s Webmaster</a> wenden.',
