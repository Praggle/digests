...
$lang = array_merge($lang, array(
	...
	'LOG_CONFIG_DIGESTS_DUPLICATE_PREVENTED'				=> '<strong>Die eMail-Zusammenfassung für %1$s (%2$s) vom %3$s, %4$d UTC wurde nicht versandt, weil innerhalb dieser Stunde schon vorher eine Zusammenfassung an diesen Abonnenten versandt worden ist.</strong>',
	...
	'LOG_CONFIG_DIGESTS_HOUR_RUN'							=> '<strong>eMail-Zusammenfassung für %1$s um %2$02d UTC gestartet.</strong>',
	...
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_BAD'						=> '<strong>eMail-Zusammnestellung für %1$s (%2$s) konnte nicht erfolgreich versandt weden</strong>',
	...
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD'						=> array(
																1 => '<strong>eMail-Zusammnestellung %1$s %2$s (%3$s) für den %4$s, %5$d UTC mit %6$d Beitrag und %7$d Privaten Nachricht</strong>',
																2 => '<strong>eMail-Zusammnestellung %1$s %2$s (%3$s) für den %4$s, %5$d UTC mit %6$d Beiträgen und %7$d Privaten Nachrichten</strong>',
															),
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD_DISK'				=> '<strong>Es wurde eine eMail-Zusammnestellung im Ordner cache/phpbbservices/digests/%s abgespeichert. Die Zusammenfassung wurde nicht per eMail versandt, sondern dort für Prüfzwecke hinterlegt.</strong>',
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD_NO_EMAIL'			=> array(
																1 => '<strong>eMail-Zusammnestellung %1$s %2$s für den %3$s, %4$d UTC mit %5$d Beitrag und %6$d Privaten Nachricht</strong>',
																2 => '<strong>eMail-Zusammnestellung %1$s %2$s für den %3$s, %4$d UTC mit %5$d Beiträgen und %6$d Privaten Nachrichten</strong>',
															),
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_NONE'						=> '<strong>Die geplante eMail-Zusammenstellung für %1$s (%2$s) wurde nicht gesendet, weil es aufgrund von Nutzer-Einstellungen und möglichen Filtervorgaben nichts zu versenden gab.</strong>',
	...
	'LOG_CONFIG_DIGESTS_SIMULATION_DATE_TIME'				=> '<strong>Ein Administrator hat eMail-Zusammenstellungen für %1$s um %2$s:00 Board-Zeit erzeugt.</strong>',
