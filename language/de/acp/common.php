...
$lang = array_merge($lang, array(
	...
	'DIGESTS_ENABLE_AUTO_SUBSCRIPTIONS_EXPLAIN'				=> 'Um bei neuen Forumsnutzern standardmäßig nach der Registrierung ein aktiviertes Abonnement zu bewirken, muss hier &rsquo;Ja&rsquo; ausgewählt sein. Es werden dabei die Standard-Vorgaben der Administration verwendet (Zu finden unter &rsquo;Standard-Nutzerkonfiguration&rsquo;). Das Aktivieren dieser Option bewirkt <em>kein</em> Abonnement bei Nutzern, deren Abonnement beendet worden ist, die inaktiv sind oder die bei der Registrierung die email-Zusammenfassung deaktiviert haben. Einzelne Nutzer lassen sich aber noch individuell mithilfe der Abonnementverwaltung hinzufügen oder pauschal mithilfe des Massen-Abonnements.',
	...
	'DIGESTS_LOWERCASE_DIGEST_TYPE_EXPLAIN'					=> 'In manchen Sprachen kann sinnvoll sein, z.B. aus &ldquo;Digest Daily My board name&rdquo; &ldquo;Digest daily of my board name&rdquo;, zu machen. Der erste Buchstabe des Board-Namens wird dabei auch verkleinert.',
	...
	'DIGESTS_RUN_TEST_TIME_USE_EXPLAIN'						=> 'Wenn hier &rsquo;Ja&rsquo; ausgewählt wird, wird die Zusammenstellung so generiert und versendet, als wäre jetzt dieser Zeitpunkt. &rsquo;Nein&rsquo; bedeutet dagegen, dass die aktuelle Uhrzeit und das heutige Datum verwendet werden.',
